...
export const ADD_ONS = [
  { id: 'wet_printer', label: 'Wet Ticket Printer', amount: 75, period: 'per month', icon: 'print' },
  { id: 'branded_site', label: 'Branded Website/Orders', amount: 20, period: 'per month', icon: 'language' },
  { id: 'driver_app', label: 'Driver App', amount: 15, period: 'per month', icon: 'local_shipping' },
];

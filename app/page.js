              ...
              <div className="reveal reveal-up relative z-10">
                ...
                <h1 className="text-6xl font-black tracking-tighter text-slate-900 md:text-8xl lg:text-9xl mb-10 leading-[1.1] md:leading-[1.15] font-outfit">
                  {t('landing_title').split(' ').map((word, i) => {
                    const isHighlight = i > 4; // Highlight the latter part
                    return (
                ...
                <div className="flex flex-wrap gap-5">
                  <Link href="/signup" className="rounded-[1.25rem] px-10 py-5 text-sm font-black text-white primary-gradient shadow-2xl shadow-emerald-500/40 hover:scale-105 active:scale-95 transition-all duration-300 shimmer-button">
                    {t('start_trial')}
                  </Link>
          ...
          <div className="primary-gradient rounded-[4rem] p-16 md:p-32 text-center relative overflow-hidden group shadow-[0_32px_128px_-16px_rgba(16,185,129,0.4)]">
            ...
            <div className="relative reveal reveal-up">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                <Link href="/signup" className="rounded-2xl bg-white px-12 py-6 text-sm font-black text-emerald-600 shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300">

...
export default function NewOrder() {
  ...
  const garmentTypes = useMemo(() => ['All', ...new Set(Array.isArray(pricing) ? pricing.map(p => p.garment_type) : [])], [pricing]);
  ...
  return (
    <div className="flex flex-col gap-4 lg:overflow-y-auto">
      ...
      {currentStep <= 2 && (
        <div className="grid lg:grid-cols-12 gap-4 flex-1 overflow-y-auto">
          <ServiceCatalog 
